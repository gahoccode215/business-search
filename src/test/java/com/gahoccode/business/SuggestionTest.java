...
import com.gahoccode.business.util.Constants;
...
public class SuggestionTest extends AbstractTest {
    ...
    @BeforeAll
    public void setup(){
        var indexMapping = this.readResource("suggestion-index-mapping.json", new TypeReference<Map<String, Object>>() {
        });
        var suggestionData = this.readResource("suggestion-data.json", new TypeReference<List<Object>>() {
        });
